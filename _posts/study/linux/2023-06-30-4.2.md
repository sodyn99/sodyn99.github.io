...
- task in 'ns3-core' failed with exit status 1: (csv-reader.cc 파일 오류)
  ...
  | 오류  | 해결  |
  | :---: | :---: |
  | error: ‘numeric_limits’ is not a member of ‘std’  | <a href="https://stackoverflow.com/questions/71296302/numeric-limits-is-not-a-member-of-std" target="_blank">csv-reader.h 파일에<br>`#include <stddef.h>`<br>`#include <limits>`<br>를 포함시킨다.</a><br>  `$ vi ./src/core/helper/csv-reader.h` |
