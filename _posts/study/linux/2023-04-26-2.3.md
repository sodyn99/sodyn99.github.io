...
- WiringOP-Zero 라이브러리 설치 후, 아래 명령어를 통해 GPIO 핀 번호를 확인할 수 있다.
    ...
    <p><img src="/images/linux/2.3-1.png" class="gallery-img" width="70%" height="70%"/></p>
...
- 저항을 연결한 후, LED의 긴 다리를 GPIO 핀에 연결하고, 짧은 다리를 GND에 연결한다.
    ...
    <p><img src="/images/linux/2.3-2.png" class="gallery-img" width="40%" height="40%"/></p>
...
- 확인 했다면, 아래 C언어 코드를 이용해 LED를 깜빡거리게 할 수 있다.
    ...
    <p><img src="/images/linux/2.3-3.png" class="gallery-img" width="80%" height="80%"/></p>
    ...
    <p><img src="/images/linux/2.3-4.png" class="gallery-img" width="30%" height="30%"/></p><p><video src="/videos/linux/2.3-1.mp4" style="border-radius:0.5rem;" width="30%" height="30%" controls muted></video></p>
