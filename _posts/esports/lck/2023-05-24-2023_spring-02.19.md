...
<div class="match-esports">
  ...
  <div class="esports-ban-slash1">
    <i class="fas fa-slash fa-rotate-90 fa-lg" style="color:red;margin-left:-1vmin;"></i>
    <i class="fas fa-slash fa-rotate-90 fa-lg" style="color:red;margin-left:0vmin;"></i>
    <i class="fas fa-slash fa-rotate-90 fa-lg" style="color:red;margin-left:0vmin;"></i>
    <i class="fas fa-slash fa-rotate-90 fa-lg" style="color:red;margin-right:0vmin;"></i>
    <i class="fas fa-slash fa-rotate-90 fa-lg" style="color:red;margin-right:2.7vmin;"></i>
  </div>
