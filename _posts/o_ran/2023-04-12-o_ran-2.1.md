...
## Setup
<a href ="https://github.com/wineslab/colosseum-oran-commag-dataset" target="_blank" rel="noopener noreferrer"><img src="https://img.icons8.com/ios-glyphs/120/null/github.png" width="15" height="15" border = "0"></a> [**colosseum-oran-commag-dataset**](https://github.com/wineslab/colosseum-oran-commag-dataset){:target="_blank"}
...
## 테스트 코드 분석
<details>
<summary><span style="color:#24A091;font-weight:bold;">test_agent_release.py</span></summary>
<div markdown = "1">
<br>
...
## pb tensorboard
<span style="color:#24A091;font-weight:bold;">Colab에서 tensorboard 띄워 saved_model.pb 확인하기 &#8594;</span> [pb_tensorboard.ipynb](https://colab.research.google.com/drive/1xZojEAytIyCpx_3GJUxtOxn-aZ5v1IJo?usp=sharing){:target="_blank"}{: .btn .btn--success}
...
- Water-filling
    ...
    다수의 서로 독립적인 채널에 대해 무선 채널 환경에서 가질 수 있는 채널 용량
        ...
        - 아래 그림은 6개 서브채널로 이루어진 전송 시스템에서의 water-filling 방법을 보여준다.
            ...
            <img src="/images/o_ran/2.1-3.png" width="50%" height="50%">
...
- Max $C/I$
    ...
    - Max $C/I$는 채널 상태가 가장 좋은 사용자에게 모든 전력을 할당한다.
        ...
        <img src="/images/o_ran/2.1-4.png" width="50%" height="50%">
...
[1] John M. Cioffi. *[Multi-Channel Modulation](https://cioffi-group.stanford.edu/doc/book/chap4.pdf){:target="_blank"}*. Stanford University, [EE379C : Advanced Digital Communication](https://web.stanford.edu/class/ee379c/){:target="_blank"}, 633-635.

[2] Merwais Shinwari, Amr Youssef, Senior Member. *[A Water-Filling Based Scheduling Algorithm for the Smart Grid](https://users.encs.concordia.ca/~youssef/Publications/Papers/A%20Water-Filling%20Based%20Scheduling%20Algorithm%20for%20the%20Smart%20Grid.pdf){:target="_blank"}*. IEEE TRANSACTIONS ONSMARTGRID,VOL.3,NO.2, (June 2012).