...
- 확인 했다면, 아래 C언어 코드를 이용해 LED를 깜빡거리게 할 수 있다.
    ...
    <p><span style="vertical-align: 50%;"><img src="/images/linux/2.3-4.png" class="radius_img" width="30%" height="30%"/>&emsp;<video src="/videos/linux/2.3-1.mp4" width="30%" height="30%" controls muted></video></span></p>
