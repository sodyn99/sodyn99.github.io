...
2. 회로 연결
    ...
    - 저항을 연결한 후, LED의 긴 다리를 GPIO 핀에 연결하고, 짧은 다리를 GND에 연결한다.
        ...
        <p><img src="/images/linux/2.3-2.png" class="radius_img" width="70%" height="70%"/></p>
...
1. 컴파일 및 실행
    ...
    - 확인 했다면, 아래 C언어 코드를 이용해 LED를 깜빡거리게 할 수 있다.
        ...
        <p><img src="/images/linux/2.3-3.png" class="radius_img" width="70%" height="70%"/></p>
        ...
        <p><img src="/images/linux/2.3-4.png" class="radius_img" width="70%" height="70%"/></p>
