...
- Host OS로 리눅스를 사용하여 생성한 컨테이너를 host OS로 윈도우를 사용하는 환경에서 사용할 수 있다. ( <span style="color=$blue;">O</span> )  
- 다른 Pod 내부의 컨테이너들은 같은 ip 주소를 가질 수 없다. ( <span style="color=$red;">X</span> )  
