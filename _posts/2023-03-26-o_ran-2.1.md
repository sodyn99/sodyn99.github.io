...
3. 배치 및 인터페이스
    - 분해 배치의 한 예 “시나리오 B”
        ...
        <img src="/images/2023-03-26-o_ran-2.1/architecture.png" width="70%" height="70%">
...
- Water-filling
    ...
    다수의 서로 독립적인 채널에 대해 무선 채널 환경에서 가질 수 있는 채널 용량
        ...
        - 아래 그림은 6개 서브채널로 이루어진 전송 시스템에서의 water-filling 방법을 보여준다.
            ...
            <img src="/images/2023-03-26-o_ran-2.1/waterfilling.png" width="50%" height="50%">
...
- Max $C/I$
    ...
    - Max $C/I$는 채널 상태가 가장 좋은 사용자에게 모든 전력을 할당한다.
        ...
        <img src="/images/2023-03-26-o_ran-2.1/maxCI.png" width="50%" height="50%">
